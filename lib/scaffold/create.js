...
var BASE_PACKAGE = {
  description: 'A full RavenDark node build with RavenDarkCore',
  repository: 'https://github.com/raven-dark/ravendark',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    '@dashevo/dashcore-lib': 'raven-dark/ravendark-lib',
    '@dashevo/dashcore-node': 'raven-dark/ravendark-node'
  }
};
